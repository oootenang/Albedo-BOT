...
global.sgh = 'https://github.com/oootenang/' // github
global.sgc = 'https://chat.whatsapp.com/GpwaG5nvU2yCitgJ7c8o8f' // group whatsapp
...
/*============== PAYMENT ==============*/
global.pdana = '6281938681806' //dana
global.povo = '-' //ovo
global.pgopay = '-' //gopay
global.plinkaja = '6281938681806' //link aja
global.ppulsa = '-' //telkomsel
global.ppulsa2 = '6283137750223' // kalau ada kartu lain isi aja
global.psaweria = 'https://saweria.com/'

/*============== NOMOR ==============*/
global.nomorbot = '6283137750233'
global.nomorown = '6285756448056'
global.namebot = 'Ikhsan-XD'
global.nameown = 'Ikhsan-Store'

/*============== Github Thanks To ==============*/
global.namagithub = 'oootenang' // nama github lu
global.linkgithub = 'github.com/oootenang/' // tarok link github lu
...
/*============== STAFF ==============*/
global.owner = [
  ['6285756448056', 'Ikhsan-Store', true], 
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
global.prems = ['6285756448056'] // Premium user bukan disini nambahinnya, ketik .addprem @user 10
...
/*============== WATERMARK ==============*/
global.wm = '                「 Ikhsan-XD 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Ikhsan-XD ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Ikhsan-XD '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ Ikhsan-XD | By Ikhsan-Store`
global.packname = 'Ikhsan-XD WhatsApp'
global.author = '                「 Ikhsan-XD  あ」'
